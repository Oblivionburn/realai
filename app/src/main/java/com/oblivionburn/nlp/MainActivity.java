...
public class MainActivity extends Activity implements OnItemSelectedListener
{
    ...
    private void DisplayTips()
    {
        ...
        tips += "== 한국어 ==\n" +
                "AI를 가르치기 위한 몇가지 팁은 다음과 같습니다. \n\n" +
                "1. AI는 당신이 말하는 것에 어떻게 반응하는지 관찰함으로서 배웁니다.\n" +
                "만약 \"안녕하세요\" 라고 쓴다면 \"잘 지내세요?\", \"어떻게 지내나요?\" 라는 말로 답변을 할 수 있습니다.\n" +
                "이것은 당신이 \"안녕하세요\" 라고 말한다면 AI 는 이전에 당신이 말한 것을 모방해서 답변합니다.\n" +
                "어린아이처럼 곧 알게 될 것처럼 배우는게 아닌 당신이 한 말들을 모방하는 것입니다.\n\n" +
                "2. 이것은 학습 과정의 일부분 입니다.\n" +
                "아이들이 일찍부터 말이 되지 않는 방식으로 말을 하는 것과 비슷합니다.\n\n" +
                "3. 말이 안 되는 말이 있으면 부정 버튼을 눌러 AI를 억제할 수 있습니다.\n" +
                "또한 다음 번에 말하는 내용이 이전 항목에 대한 응답으로 간주되지 않도록 세션을 재설정합니다.\n\n" +
                "4. AI의 부정 버튼 대신 이를 권장하고 알려주는 버튼이 있습니다.\n" +
                "긍정 버튼을 누르면 이 대답을 자주 사용하게 됩니다.\n\n" +
                "5. 답변을 하나의 문장이나 질문으로 제한하세요.\n\n" +
                "6. 답합 때는 완전한 문장으로 작성하세요. 영어의 경우 대문자로 시작해서 마침표를 찍어야 하고, 한글 역시 끝에 마침표를 찍어야 합니다.\n\n" +
                "7. 영어 사용시 \"It's\" 대신 \"it is\" 를 사용하세요.\n\n"+
                "8. AI는 실시간으로 작동하며, 너무 오랫동안 방치하면 스스로 대화를 시작하려고 할겁니다.\n\n" +
                "9. AI는 당신이 언급한 '사물'을 보거나 냄새를 맡을 수 없으므로 어떠한 맥락도 가질 수 없습니다.\n" +
                "정확히 '무엇'인지에 대한 이해시키려 해도 AI는 이해할 수 없습니다.\n" +
                "왜냐하면 AI는 \"개념\"을 가질 수 없기 때문입니다.\n\n" +
                "10. 단순하게 받아들이세요. 그것에 대해 더 쉽게 말할수록 더 잘 배웁니다.\n" +
                "도움이 필요하면 Discord: https://discord.gg/VCQwCk6 에 참여하세요!\n\n" +
                "AI의 작동 방식에 대한 자세한 정보와 내용은 포럼에 있습니다.\n" +
                "http://realai.freeforums.net/#category-3\n\n";
